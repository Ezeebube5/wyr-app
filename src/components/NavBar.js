                ...
                <AppBar position="static" >
                    <Toolbar>  
                        <div className={classes.grow}>
                            ...
                            <Button color="inherit" className="navLinkButton" component={Link} to="/leaderboard">LeaderBoard</Button>
                        </div>  
                        {
                            loggedInUser? (
                                <Fragment>
                                    ...
                                    <Avatar alt="User Icon" src={loggedInUser?loggedInUser.avatarURL:""} className={classes.avatar} />      
